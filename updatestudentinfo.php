...
if(isset($_POST['update']))
{
			...
			header('refresh:1;url=managestudentinfo.php');
}
		 ...
		 ?>
              ...
              <div class="form-group">
                <div class="col-sm-12"><br>
                  ...
                  <center>
                    <button type="submit" name="update" class="btn btn-success btn-labeled">View & Update<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
