        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>Update Teacher's Information</h5>
            </div>
          </div>
          <?php if($msg){?>
...
if ($result->num_rows > 0) 
 ...
 ?>
               ...
               <td><a href="updateactionteacherinfo.php?XSTHEAJAUWLOGN4784$5$3324bjhv<?php echo $sha;?>=<?php echo $row['auto_id'];?>"><i class="fa fa-edit" title="Edit Record"></i> </a></td>
              </tr>
      <?php $cnt=$cnt+1;}} ?>
              </tbody>
            </table>
