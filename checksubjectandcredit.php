...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">Subjects and Credits</h2>
      </div>
    ...
    <div class="row breadcrumb-div">
      <div class="col-md-6">
        <ul class="breadcrumb">
          ...
          <li> Information</li>
          <li class="active">Corresponding Subjects and Credits</li>
        </ul>
      </div>
    </div>
    <!-- /.row --> 
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>Check and Update Corresponding Subjects and Credits Information for session  <strong><?php echo $session ?></strong> </h5>
            </div>
          </div>
          <?php if($msg){?>
