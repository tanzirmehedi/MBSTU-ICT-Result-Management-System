...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2018 at 07:43 AM
...
--
-- Database: `ictresult1920`
--

-- --------------------------------------------------------

--
-- Table structure for table `student192011`
--

CREATE TABLE `student192011` (
...
--
-- Dumping data for table `student192011`
--

INSERT INTO `student192011` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student192011gp`
--

CREATE TABLE `student192011gp` (
...
--
-- Table structure for table `student192012`
--

CREATE TABLE `student192012` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student192012`
--

INSERT INTO `student192012` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student192012gp`
--

CREATE TABLE `student192012gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student192021`
--

CREATE TABLE `student192021` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student192021`
--

INSERT INTO `student192021` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student192021gp`
--

CREATE TABLE `student192021gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student192022`
--

CREATE TABLE `student192022` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student192022`
--

INSERT INTO `student192022` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student192022gp`
--

CREATE TABLE `student192022gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student192031`
--

CREATE TABLE `student192031` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student192031`
--

INSERT INTO `student192031` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student192031gp`
--

CREATE TABLE `student192031gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student192032`
--

CREATE TABLE `student192032` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student192032`
--

INSERT INTO `student192032` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student192032gp`
--

CREATE TABLE `student192032gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student192041`
--

CREATE TABLE `student192041` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student192041`
--

INSERT INTO `student192041` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student192041gp`
--

CREATE TABLE `student192041gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student192042`
--

CREATE TABLE `student192042` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student192042`
--

INSERT INTO `student192042` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student192042gp`
--

CREATE TABLE `student192042gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Indexes for table `student192011`
--
ALTER TABLE `student192011`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192011gp`
--
ALTER TABLE `student192011gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192012`
--
ALTER TABLE `student192012`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192012gp`
--
ALTER TABLE `student192012gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192021`
--
ALTER TABLE `student192021`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192021gp`
--
ALTER TABLE `student192021gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192022`
--
ALTER TABLE `student192022`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192022gp`
--
ALTER TABLE `student192022gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192031`
--
ALTER TABLE `student192031`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192031gp`
--
ALTER TABLE `student192031gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192032`
--
ALTER TABLE `student192032`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192032gp`
--
ALTER TABLE `student192032gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192041`
--
ALTER TABLE `student192041`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192041gp`
--
ALTER TABLE `student192041gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192042`
--
ALTER TABLE `student192042`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student192042gp`
--
ALTER TABLE `student192042gp`
  ADD PRIMARY KEY (`auto_id`);
...
--
-- AUTO_INCREMENT for table `student192011`
--
ALTER TABLE `student192011`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student192011gp`
--
ALTER TABLE `student192011gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student192012`
--
ALTER TABLE `student192012`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student192012gp`
--
ALTER TABLE `student192012gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student192021`
--
ALTER TABLE `student192021`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student192021gp`
--
ALTER TABLE `student192021gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student192022`
--
ALTER TABLE `student192022`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student192022gp`
--
ALTER TABLE `student192022gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student192031`
--
ALTER TABLE `student192031`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student192031gp`
--
ALTER TABLE `student192031gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student192032`
--
ALTER TABLE `student192032`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student192032gp`
--
ALTER TABLE `student192032gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student192041`
--
ALTER TABLE `student192041`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student192041gp`
--
ALTER TABLE `student192041gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student192042`
--
ALTER TABLE `student192042`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student192042gp`
--
ALTER TABLE `student192042gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
