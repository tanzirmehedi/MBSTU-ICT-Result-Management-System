...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2018 at 07:37 AM
...
--
-- Database: `ictresult1819`
--

-- --------------------------------------------------------

--
-- Table structure for table `student181911`
--

CREATE TABLE `student181911` (
...
--
-- Dumping data for table `student181911`
--

INSERT INTO `student181911` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student181911gp`
--

CREATE TABLE `student181911gp` (
...
--
-- Table structure for table `student181912`
--

CREATE TABLE `student181912` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student181912`
--

INSERT INTO `student181912` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student181912gp`
--

CREATE TABLE `student181912gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student181921`
--

CREATE TABLE `student181921` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student181921`
--

INSERT INTO `student181921` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student181921gp`
--

CREATE TABLE `student181921gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student181922`
--

CREATE TABLE `student181922` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student181922`
--

INSERT INTO `student181922` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student181922gp`
--

CREATE TABLE `student181922gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student181931`
--

CREATE TABLE `student181931` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student181931`
--

INSERT INTO `student181931` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student181931gp`
--

CREATE TABLE `student181931gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student181932`
--

CREATE TABLE `student181932` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student181932`
--

INSERT INTO `student181932` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student181932gp`
--

CREATE TABLE `student181932gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student181941`
--

CREATE TABLE `student181941` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student181941`
--

INSERT INTO `student181941` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student181941gp`
--

CREATE TABLE `student181941gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student181942`
--

CREATE TABLE `student181942` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student181942`
--

INSERT INTO `student181942` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student181942gp`
--

CREATE TABLE `student181942gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Indexes for table `student181911`
--
ALTER TABLE `student181911`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181911gp`
--
ALTER TABLE `student181911gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181912`
--
ALTER TABLE `student181912`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181912gp`
--
ALTER TABLE `student181912gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181921`
--
ALTER TABLE `student181921`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181921gp`
--
ALTER TABLE `student181921gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181922`
--
ALTER TABLE `student181922`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181922gp`
--
ALTER TABLE `student181922gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181931`
--
ALTER TABLE `student181931`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181931gp`
--
ALTER TABLE `student181931gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181932`
--
ALTER TABLE `student181932`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181932gp`
--
ALTER TABLE `student181932gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181941`
--
ALTER TABLE `student181941`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181941gp`
--
ALTER TABLE `student181941gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181942`
--
ALTER TABLE `student181942`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student181942gp`
--
ALTER TABLE `student181942gp`
  ADD PRIMARY KEY (`auto_id`);
...
--
-- AUTO_INCREMENT for table `student181911`
--
ALTER TABLE `student181911`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student181911gp`
--
ALTER TABLE `student181911gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student181912`
--
ALTER TABLE `student181912`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student181912gp`
--
ALTER TABLE `student181912gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student181921`
--
ALTER TABLE `student181921`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student181921gp`
--
ALTER TABLE `student181921gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student181922`
--
ALTER TABLE `student181922`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student181922gp`
--
ALTER TABLE `student181922gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student181931`
--
ALTER TABLE `student181931`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student181931gp`
--
ALTER TABLE `student181931gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student181932`
--
ALTER TABLE `student181932`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student181932gp`
--
ALTER TABLE `student181932gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student181941`
--
ALTER TABLE `student181941`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student181941gp`
--
ALTER TABLE `student181941gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student181942`
--
ALTER TABLE `student181942`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student181942gp`
--
ALTER TABLE `student181942gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
