...
--
-- Database: `ictresult1718`
--

-- --------------------------------------------------------

--
-- Table structure for table `student171811`
--

CREATE TABLE `student171811` (
...
--
-- Dumping data for table `student171811`
--

INSERT INTO `student171811` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student171811gp`
--

CREATE TABLE `student171811gp` (
...
--
-- Table structure for table `student171812`
--

CREATE TABLE `student171812` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student171812`
--

INSERT INTO `student171812` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student171812gp`
--

CREATE TABLE `student171812gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student171821`
--

CREATE TABLE `student171821` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student171821`
--

INSERT INTO `student171821` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student171821gp`
--

CREATE TABLE `student171821gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student171822`
--

CREATE TABLE `student171822` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student171822`
--

INSERT INTO `student171822` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student171822gp`
--

CREATE TABLE `student171822gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student171831`
--

CREATE TABLE `student171831` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student171831`
--

INSERT INTO `student171831` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student171831gp`
--

CREATE TABLE `student171831gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student171832`
--

CREATE TABLE `student171832` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student171832`
--

INSERT INTO `student171832` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student171832gp`
--

CREATE TABLE `student171832gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student171841`
--

CREATE TABLE `student171841` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student171841`
--

INSERT INTO `student171841` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student171841gp`
--

CREATE TABLE `student171841gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Table structure for table `student171842`
--

CREATE TABLE `student171842` (
  `auto_id` int(10) NOT NULL,
  `code` varchar(10) NOT NULL,
  `title` varchar(255) NOT NULL,
  `credit` varchar(10) NOT NULL,
...
--
-- Dumping data for table `student171842`
--

INSERT INTO `student171842` (`auto_id`, `code`, `title`, `credit`, `updatetime`, `ident`) VALUES
...
--
-- Table structure for table `student171842gp`
--

CREATE TABLE `student171842gp` (
  `auto_id` int(11) NOT NULL,
  `id` varchar(20) NOT NULL,
...
--
-- Indexes for table `student171811`
--
ALTER TABLE `student171811`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171811gp`
--
ALTER TABLE `student171811gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171812`
--
ALTER TABLE `student171812`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171812gp`
--
ALTER TABLE `student171812gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171821`
--
ALTER TABLE `student171821`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171821gp`
--
ALTER TABLE `student171821gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171822`
--
ALTER TABLE `student171822`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171822gp`
--
ALTER TABLE `student171822gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171831`
--
ALTER TABLE `student171831`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171831gp`
--
ALTER TABLE `student171831gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171832`
--
ALTER TABLE `student171832`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171832gp`
--
ALTER TABLE `student171832gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171841`
--
ALTER TABLE `student171841`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171841gp`
--
ALTER TABLE `student171841gp`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171842`
--
ALTER TABLE `student171842`
  ADD PRIMARY KEY (`auto_id`);

--
-- Indexes for table `student171842gp`
--
ALTER TABLE `student171842gp`
  ADD PRIMARY KEY (`auto_id`);
...
--
-- AUTO_INCREMENT for table `student171811`
--
ALTER TABLE `student171811`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student171811gp`
--
ALTER TABLE `student171811gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student171812`
--
ALTER TABLE `student171812`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student171812gp`
--
ALTER TABLE `student171812gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student171821`
--
ALTER TABLE `student171821`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `student171821gp`
--
ALTER TABLE `student171821gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student171822`
--
ALTER TABLE `student171822`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student171822gp`
--
ALTER TABLE `student171822gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student171831`
--
ALTER TABLE `student171831`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student171831gp`
--
ALTER TABLE `student171831gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student171832`
--
ALTER TABLE `student171832`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student171832gp`
--
ALTER TABLE `student171832gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student171841`
--
ALTER TABLE `student171841`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student171841gp`
--
ALTER TABLE `student171841gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student171842`
--
ALTER TABLE `student171842`
  MODIFY `auto_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `student171842gp`
--
ALTER TABLE `student171842gp`
  MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
