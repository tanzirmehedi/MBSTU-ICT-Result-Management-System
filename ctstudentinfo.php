...
if ($resultd->num_rows > 0)
    ...
    while($rowd = $resultd->fetch_assoc()) 
	   ...
	   if(empty($ct1[2]) && empty($ct1[3]) && empty($ct1[4]) && empty($ct1[5]))
	   {
		   $redirect=0;
	   }
	   else 
...
if ($resultd->num_rows > 0)
    ...
    while($rowd = $resultd->fetch_assoc()) 
	   ...
	   if(empty($ct2[2]) && empty($ct2[3]) && empty($ct2[4]) && empty($ct2[5]))
	   {
		   $redirect=0;
	   }
	   else 
...
if ($resultd->num_rows > 0)
    ...
    while($rowd = $resultd->fetch_assoc()) 
	   ...
	   if(empty($ct3[2]) && empty($ct3[3]) && empty($ct3[4]) && empty($ct3[5]))
	   {
		   $redirect=0;
	   }
	   else 
...
if ($resultd->num_rows > 0)
    ...
    while($rowd = $resultd->fetch_assoc()) 
	   ...
	   if(empty($ct4[2]) && empty($ct4[3]) && empty($ct4[4]) && empty($ct4[5]))
	   {
		   $redirect=0;
	   }
	   else 
			...
			<?php
             ...
             ?>
                ...
                <?php }} $cnt=$cnt+1;}} ?>  
                  ...
                  <center>
                    <button type="submit" name="update" class="btn btn-success btn-labeled">Complete <span class="btn-label btn-label-right"><i class="fa fa-angle-double-right"></i></span></button>
