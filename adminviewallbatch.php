...
<title><?php echo $user_name; ?> | View Batch Information</title>
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>View batch information by clicking view button</h5>
            </div>
          </div>
          <?php if($msg){?>
...
if ($result->num_rows > 0) 
 ...
 ?>
               ...
               <td><a href="adminupdatebatchinfo.php?<?php echo $sha;?>XSTHEAJAUWLOGN4784$5$3324bjhv=<?php echo $row['auto_id'];?>"><i class="fa fa-database" title="Edit Record"></i> </a></td>
              </tr>
      <?php $cnt=$cnt+1;}} ?>
              </tbody>
            </table>
