...
<title><?php echo $user_name; ?> | View Message</title>
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>See full message by clicking view button</h5>
            </div>
          </div>
          <?php if($msg){?>
          ...
          <div class="panel-body p-20">
            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
              ...
              <tbody>
<?php $sql = "SELECT * FROM message order by creationdate desc ";
$result = $dbh->query($sql);
if ($result->num_rows > 0) 
   {
    while($row = $result->fetch_assoc())
 ...
 ?>
               ...
               <td><center><a href="updatestudentinfo.php?XSTHEAJAUWLOGN4784$5$3324bjhv=<?php echo $row['auto_id'];?>"> View</a></td>
              </tr>
      <?php }} ?>
              </tbody>
            </table>
