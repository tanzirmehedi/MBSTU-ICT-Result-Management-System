...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">Teacher's Information</h2>
      </div>
    ...
    <div class="row breadcrumb-div">
      <div class="col-md-6">
        <ul class="breadcrumb">
          ...
          <li> Information</li>
          <li class="active">Teacher's Information</li>
        </ul>
      </div>
    </div>
    <!-- /.row --> 
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>Check and Update Corresponding teacher's information </h5>
            </div>
          </div>
          <?php if($msg){?>
          ...
          <div class="panel-body p-20">
            ...
            $sql = "SELECT *FROM tbatch where year <> '' AND semester<> '' ";
            $result = $dbh->query($sql);
            $cnt=1;
            if ($result->num_rows > 0) 
               {
             ...
             ?>
                           ...
                           <td><a href="updatesetteacher.php?gghyXS<?php echo $sha;?>THEAJAUWLOGN4784$5$3324bjhv=<?php echo $row['user_name'];?>"><i class="fa fa-edit" title="Create Result"></i> </a></td>
