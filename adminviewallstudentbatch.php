...
<title><?php echo $user_name; ?> | View Student Information</title>
...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">View Student Information</h2>
      </div>
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>View student's information by clicking view button</h5>
            </div>
          </div>
          <?php if($msg){?>
...
if ($result->num_rows > 0) 
 ...
 ?>
               ...
               <td><a href="adminupdatestudentinfo.php?XSTHE<?php echo $sha;?>AJAUWLOGN4784$5$3324bjhv=<?php echo $row['auto_id'];?>"><i class="fa fa-forward" title="View Record"></i> </a></td>
              </tr>
      <?php $cnt=$cnt+1;}} ?>
              </tbody>
            </table>
