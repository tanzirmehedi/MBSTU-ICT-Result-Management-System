...
if(isset($_POST['update']))
{
			...
			$msg="Wait few secounds";
			 $sha=md5($user_name);
			 $content="managestudentinfo.php?X".$sha."sErCXz@FCggVJyGYG%vvKIKhv45747551".$sha;
    ...
    <div class="row">
      <div class="col-md-12">
		...
		<?php 
		 $sha=md5($user_name);
        $sha=$sha.$sha;
	    $mai="XSTHE".$sha."AJAUWLOGN4784$5$3324bjhv";
		$cid=intval($_GET[$mai]);
		 ...
		 ?>
              ...
              <div class="form-group">
                <div class="col-sm-12"><br>
                  ...
                  <center>
                    <button type="submit" name="update" class="btn btn-success btn-labeled">View <span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
