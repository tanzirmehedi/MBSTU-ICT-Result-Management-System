...
if(isset($_POST['update']))
{
			...
			$msg="Wait few secounds";	
			 ...
			 $sha=md5($user_name);
			 $content="createresultsemester.php?cGHTdvAASzxsctYteGDVJyGYG%vvKI".$sha."Khv45747551".$sha;
...
if($new_data==$_SESSION['user_name']  && $mainadmin==1 && $st=="admin" || $st=="teacher"):
        ...
        $sha=md5($user_name);
        $sha=$sha.$sha;
	    $mai="ioUiX".$sha."STHEAJAUWLOGN4784$5$3324bjhv";
		$cid=intval($_GET[$mai]);
...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">Create Result</h2>
      </div>
    </div>
    <!-- /.row -->
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="panel-heading">Your provide informations for this semester</div>
