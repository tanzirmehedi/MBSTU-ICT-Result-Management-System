...
<title><?php echo $user_name; ?> | Update Student Information</title>
...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">Update Student Information</h2>
      </div>
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>Update student's information by clicking action button</h5>
            </div>
          </div>
          <?php if($msg){?>
...
if ($result->num_rows > 0) 
 ...
 ?>
               ...
               <td><a href="updatestudentinfo.php?XSTHEAJAUWLOGN4784$5$3324bjhv=<?php echo $row['auto_id'];?>"><i class="fa fa-edit" title="Edit Record"></i> </a></td>
              </tr>
      <?php $cnt=$cnt+1;}} ?>
              </tbody>
            </table>
