 ...
 if(isset($_POST['update']))
{
	$user_name=$user_name;	
      ...
      $sql="INSERT INTO finish (user_name) VALUES('$user_name')";
	

		  if (mysqli_query($dbh, $sql))
			{		
			$msg="Now you can insert result for students";	
			...
			header('refresh:2;url=createresultstudentinfo.php');
			}
}

$mainadmin=0;

if($st=="admin" || $st=="register" || $st=="teacher")
{
   $mainadmin=1;
}
...
if(($new_data==$_SESSION['user_name']  && $mainadmin==1 && (!empty($session))&& $st=="admin")||($new_data==$_SESSION['user_name']  && $mainadmin==1 && (!empty($session))&& $st=="teacher" ) ||($new_data==$_SESSION['user_name']  && $mainadmin==1 && (!empty($session))&& $st=="register" )):
    ...
    <div class="row breadcrumb-div">
      <div class="col-md-6">
        <ul class="breadcrumb">
          ...
          <li> Information</li>
          <li class="active">Studnt's Information</li>
        </ul>
      </div>
    </div>
    <!-- /.row --> 
            ...
            if ($result->num_rows > 0) 
             ...
             ?>
                           <tr>
                            ...
                            <?php  if($new_data==$_SESSION['user_name']  && $mainadmin==1 && $st=="register" ): ?>
                           <td><a href="updateactionstudent.php?XSTHEAJAUWLOGN4784$5$3324bjhv=<?php echo $row['id'];?>"><i class="fa fa-edit" title="Edit Record"></i> </a></td>
                           <?php endif; ?>
                          </tr>
                ...
                <form  class="form-group" method="post">
                  <center>
                    <button type="submit" name="update" class="btn btn-success btn-labeled">Finish<span class="btn-label btn-label-right"><i class="fa fa-angle-double-right"></i></span></button>
