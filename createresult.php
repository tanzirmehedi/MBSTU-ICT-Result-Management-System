...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">Create New Result</h2>
      </div>
    ...
    <div class="row breadcrumb-div">
      <div class="col-md-6">
        <ul class="breadcrumb">
          ...
          <li> Management</li>
          <li class="active">Create New Result</li>
        </ul>
      </div>
    </div>
    <!-- /.row --> 
...
if ($result->num_rows > 0) 
 ...
 ?>
               ...
               <td><a href="createresultbatch.php?ioUiX<?php echo $sha;?>STHEAJAUWLOGN4784$5$3324bjhv=<?php echo $row['auto_id'];?>"><i class="fa fa-forward" title="View Record"></i> </a></td>
              </tr>
      <?php $cnt=$cnt+1;}} ?>
              </tbody>
            </table>
