...
?>
 <?php if($new_data==$_SESSION['user_name']  && $mainadmin==1): ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<?php include('includes/teachertopbar.php');?>
...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">Teacher's List</h2>
      </div>
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>View Teacher's Information</h5>
            </div>
          </div>
          <div class="panel-body p-20">
            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
              ...
              <tbody>
<?php $sql = "SELECT * FROM teacherinfo";
$result = $dbh->query($sql);
if ($result->num_rows > 0) 
   {
    while($row = $result->fetch_assoc())
