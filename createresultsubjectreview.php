...
<title><?php echo $user_name; ?> | Create Result</title>
...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">Semester Subject Review </h2>
      </div>
    ...
    <div class="row breadcrumb-div">
      <div class="col-md-6">
        <ul class="breadcrumb">
          ...
          <li> Information</li>
          <li class="active">Subject review for this semester</li>
        </ul>
      </div>
    </div>
    <!-- /.row --> 
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>Click corresponding semester for session  <strong><?php echo $session ?></strong> to create result </h5>
            </div>
          </div>
          <?php if($msg){?>
	    ...
	    $mai=$sha."XSTHEAJAUWLOGN4784$5$3324bjhv"; ?>
            ...
            <center>
                    <a href="createresultstudentinfo.php?<?php echo $mai ?> "><button class="btn btn-success btn-labeled">Next<span class="btn-label btn-label-right"><i class="fa fa-angle-double-right"></i></span></button></a>
