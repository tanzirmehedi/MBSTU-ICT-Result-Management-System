...
{  
         ...
         $sql="UPDATE ct SET publish = 'publish', pct4='pct4' where session='$session'";
		  ...
		  if (mysqli_query($dbh, $sql))
			{		
			$msg="Updated class test marks has been published.";
			$sha=md5($user_name);
                ...
                while($rowp = $resultp->fetch_assoc())
                 {
					...
					$message= "Dear Student, Course code: ".$coursecode." , class test: 0".$postid." marks has been updated at $time. Please check your class test marks through website 103.28.121.91.";
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>Please check updated marks for class test  <strong><?php echo $postid ?></strong> those session  <strong><?php echo $session ?></strong> and course code <strong><?php echo $coursecode ?></strong> </h5>
            </div>
          </div>
          <?php if($msg){?>
