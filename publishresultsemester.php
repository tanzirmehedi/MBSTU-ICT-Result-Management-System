...
<title><?php echo $user_name; ?> | Publish Result</title>
...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">All semester </h2>
      </div>
    ...
    <div class="row breadcrumb-div">
      <div class="col-md-6">
        <ul class="breadcrumb">
          ...
          <li> Information</li>
          <li class="active">All Semester for this session</li>
        </ul>
      </div>
    </div>
    <!-- /.row --> 
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>Click corresponding semester for session  <strong><?php echo $session ?></strong> to publish result </h5>
            </div>
          </div>
          <?php if($msg){?>
            ...
            if ($result->num_rows > 0) 
             ...
             ?>
                           <tr>
                            ...
                            <td><?php echo $row['semester'];?> Semester</td>
                            <td><?php echo $row['creationdate'];?></td>                          
                           <td><a href="lastpublishresultstudentinfo.php?<?php echo $sha;?><?php echo $sha;?>XSTHEAJAUWLOGN4784$5$3324bjhv=<?php echo $row['auto_id'];?>"> View</a></td>
