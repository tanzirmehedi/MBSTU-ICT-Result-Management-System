...
if(isset($_POST['update']))
{
			...
			header('refresh:1;url=checksubjectandcredit.php');
}

if(isset($_POST['delete']))
{
	$cid=intval($_GET['XSTHEAJAUWLOGN4784$5$3324bjhv']);
	$sqll="DELETE FROM tbatch WHERE auto_id='$cid'";


	     if (mysqli_query($dbh, $sqll))
		   {		
			$msg="Data has been deleted successfully";	
			header('refresh:2;url=viewallbatch.php');
			}
		 else 
			{
              ...
              <div class="form-group">
                <div class="col-sm-12"><br>
                  ...
                  <center>
                    ...
                    <button type="submit" name="delete" class="btn btn-danger btn-labeled">Delete Batch Information<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                  </center>
