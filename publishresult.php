    ...
    <div class="row breadcrumb-div">
      <div class="col-md-6">
        <ul class="breadcrumb">
          ...
          <li> Management</li>
          <li class="active">Publish New Result</li>
        </ul>
      </div>
    </div>
    <!-- /.row --> 
...
if ($result->num_rows > 0) 
 ...
 ?>
               ...
               <td><a href="publishresultbatch.php?ioUiX<?php echo $sha;?>STHEAJAUWLOGN4784$5$3324bjhv=<?php echo $row['auto_id'];?>"><i class="fa fa-forward" title="View Record"></i> </a></td>
              </tr>
      <?php $cnt=$cnt+1;}} ?>
              </tbody>
            </table>
