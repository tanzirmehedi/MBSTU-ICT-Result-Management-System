...
<title><?php echo $user_name; ?> | Insert Marks</title>
...
<div class="main-page">
  <div class="container-fluid">
    <div class="row page-title-div">
      <div class="col-md-6">
        <h2 class="title">Insert Marks </h2>
      </div>
    ...
    <div class="row breadcrumb-div">
      <div class="col-md-6">
        <ul class="breadcrumb">
          ...
          <li> Marks</li>
          <li class="active">Insert new marks</li>
        </ul>
      </div>
    </div>
    <!-- /.row --> 
        ...
        <div class="panel">
          <div class="panel-heading">
            <div class="panel-title">
              <h5>Choose semester by clicking action button</h5>
            </div>
          </div>
          <?php if($msg){?>
...
if ($result->num_rows > 0) 
 ...
 ?>
               ...
               <td><a href="createresultbatchinsert.php?<?php echo $sha;?>XSTHEAJAUWLOGN<?php echo $sha;?>4784$5$3324bjhv=<?php echo $row['session'];?>"><i class="fa fa-forward" title="View Record"></i> </a></td>
              </tr>
      <?php $cnt=$cnt+1;}} ?>
              </tbody>
            </table>
