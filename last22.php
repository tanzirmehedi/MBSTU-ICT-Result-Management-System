        ...
        <?php 
         ...
         $status=gpacheck22($finalgpa); 
            if($status=="Result Not Yet Published"):
             ?>
             <center><strong>Status: </strong> <strong class="color-warning"> <?php echo gpacheck22($finalgpa);?> </strong> </center>
           <br>
           ...
           if($status=="Promoted"):
             ?>
             <center><strong>Status: </strong> <strong class="color-success"> <?php echo gpacheck22($finalgpa);?> </strong> </center>
           <br>
           ...
           if($status=="Not Promoted"):
             ?>
             <center><strong>Status: </strong> <strong class="color-danger"> <?php echo gpacheck22($finalgpa);?> </strong> </center>
           <br>
